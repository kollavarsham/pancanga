...
print "\n\nCalling calulations for 2014 02 11\n\n";
our $year = 2014;
our $month = 02;
our $day = 11;
&calculations;
...
$function_name = "get_true_long";
print "\n\nTesting the function \"" . $function_name . "\"\n\n";

&test("(1710693,215.330481398828,'mercury')");
&test("(1710694,216.345092245966,'mercury')");
&test("(1710695,217.360117559963,'mercury')");
&test("(1710696,218.375548627069,'mercury')");
&test("(1772755,183.139229101953,'mercury')");
&test("(1772756,184.136821438217,'mercury')");
&test("(1772757,185.135030298228,'mercury')");
&test("(1132992,355.302664567532,'mercury')");
&test("(1868191,288.309252298232,'mercury')");
&test("(1868192,289.32751969395,'mercury')");
&test("(1867492,320.200309773426,'mercury')");
&test("(1867886,348.803993428264,'mercury')");
&test("(1867520,348.072902270539,'mercury')");
&test("(1844848,322.249740952942,'mercury')");
&test("(1710693,215.330481398828,'venus')");
&test("(1710694,216.345092245966,'venus')");
&test("(1710695,217.360117559963,'venus')");
&test("(1710696,218.375548627069,'venus')");
&test("(1772755,183.139229101953,'venus')");
&test("(1772756,184.136821438217,'venus')");
&test("(1772757,185.135030298228,'venus')");
&test("(1132992,355.302664567532,'venus')");
&test("(1868191,288.309252298232,'venus')");
&test("(1868192,289.32751969395,'venus')");
&test("(1867492,320.200309773426,'venus')");
&test("(1867886,348.803993428264,'venus')");
&test("(1867520,348.072902270539,'venus')");
&test("(1844848,322.249740952942,'venus')");
&test("(1710693,215.330481398828,'mars')");
&test("(1710694,216.345092245966,'mars')");
&test("(1710695,217.360117559963,'mars')");
&test("(1710696,218.375548627069,'mars')");
&test("(1772755,183.139229101953,'mars')");
&test("(1772756,184.136821438217,'mars')");
&test("(1772757,185.135030298228,'mars')");
&test("(1132992,355.302664567532,'mars')");
&test("(1868191,288.309252298232,'mars')");
&test("(1868192,289.32751969395,'mars')");
&test("(1867492,320.200309773426,'mars')");
&test("(1867886,348.803993428264,'mars')");
&test("(1867520,348.072902270539,'mars')");
&test("(1844848,322.249740952942,'mars')");
&test("(1710693,215.330481398828,'saturn')");
&test("(1710694,216.345092245966,'saturn')");
&test("(1710695,217.360117559963,'saturn')");
&test("(1710696,218.375548627069,'saturn')");
&test("(1772755,183.139229101953,'saturn')");
&test("(1772756,184.136821438217,'saturn')");
&test("(1772757,185.135030298228,'saturn')");
&test("(1132992,355.302664567532,'saturn')");
&test("(1868191,288.309252298232,'saturn')");
&test("(1868192,289.32751969395,'saturn')");
&test("(1867492,320.200309773426,'saturn')");
&test("(1867886,348.803993428264,'saturn')");
&test("(1867520,348.072902270539,'saturn')");
&test("(1844848,322.249740952942,'saturn')");
&test("(1710693,215.330481398828,'saturn')");
&test("(1710694,216.345092245966,'saturn')");
&test("(1710695,217.360117559963,'saturn')");
&test("(1710696,218.375548627069,'saturn')");
